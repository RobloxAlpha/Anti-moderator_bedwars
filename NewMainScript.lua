...
game.StarterGui:SetCore("SendNotification", {Title = "Script executed successfull", Text = "Anti-moderator Executed v2.5b!"})
...
game.StarterGui:SetCore("SendNotification", {Title = "- _Custom Banned Players_ -", Text = "{" + _G.Custom + "}"})
